...
const UserProductGalleryViewer = ({ userId }) => {
  ...
  return (
    <div className="bg-[#212F35] inner-glow p-4 rounded-xl overflow-hidden h-full">
      <div className="flex items-center justify-center gap-2 mb-4 text-blue-200">
          ...
          >
            ...
            {item.productLink && (
              <a
                ...
                className="absolute top-2 right-2 bg-black/60 hover:bg-black/80 p-1 rounded-full text-blue-400 z-10"
                title="Visit link"
              >
